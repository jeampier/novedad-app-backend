...
const BASE_VARIABLES = [
  ...
  { key: 'extra_hours',               label: 'Horas extra diurna',          category: 'Horas', example: 8 },
  { key: 'extra_diur_dom_hours',      label: 'Horas extra diurna dom.',      category: 'Horas', example: 0 },
  { key: 'extra_noct_hours',          label: 'Horas extra nocturna',         category: 'Horas', example: 0 },
  { key: 'extra_noct_dom_hours',      label: 'Horas extra nocturna dom.',    category: 'Horas', example: 0 },
  { key: 'night_hours',               label: 'Horas rec. nocturno',          category: 'Horas', example: 0 },
  { key: 'surcharge_hours',           label: 'Horas rec. general',           category: 'Horas', example: 0 },
  { key: 'sunday_holiday_hours',      label: 'Horas rec. dom. diurno',       category: 'Horas', example: 0 },
  { key: 'rec_dom_noct_hours',        label: 'Horas rec. dom. nocturno',     category: 'Horas', example: 0 },
