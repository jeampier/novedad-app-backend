...
const { createContract, updateContractStatus } = require('../handlers/contractsHandler')
const { updateValidationRule } = require('../handlers/validationRulesHandler')
...
register('CreateContract', createContract)
register('UpdateContractStatus', updateContractStatus)
register('UpdateValidationRule', updateValidationRule)
